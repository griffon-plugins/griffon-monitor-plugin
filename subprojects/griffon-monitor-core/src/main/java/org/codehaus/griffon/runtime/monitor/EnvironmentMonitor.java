...
public class EnvironmentMonitor extends AbstractMBeanRegistration implements EnvironmentMonitorMXBean {
    ...
    public String getBuildDateTime() {
        return GriffonEnvironment.getBuildDateTime();
    }

    @Override
    public String getBuildTime() {
        return GriffonEnvironment.getBuildTime();
    }

    @Override
    public String getGriffonVersion() {
        return GriffonEnvironment.getGriffonVersion();
    }

    @Override
    public String getJvmVersion() {
        return GriffonEnvironment.getJvmVersion();
    }
